...
export default function Index() {
    return (
        <>
            <Layout>
                <section className="bg-green-gradient dark:bg-gray-900 pt-20">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                        ...
                        <p className="mb-8 text-lg font-heading3 text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                            ...
                            serene haven invites visitors to reconnect with
                            nature. Crystal-clear streams, towering trees, and
                            vibrant wildflowers create a tranquil escape where
                            every trail leads to breathtaking views and peaceful
                            moments.
                        </p>
